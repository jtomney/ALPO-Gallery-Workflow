...
using ALPOGalleryTool.DataAccess.SaturnCmDataSetTableAdapters;
...
namespace ALPOGalleryTool
{
    public class SaturnCentralMeridian
    {
        ...
        private SaturnCmDataSet.vwSaturnCMDataTable _saturnDataSet = new SaturnCmDataSet.vwSaturnCMDataTable();
        ...
        public string GetSaturnCMbyObsrvDt(DateTime obsrvDt, string system)
        {
            ...
            foreach (SaturnCmDataSet.vwSaturnCMRow rw in _saturnDataSet.Rows)
            {
